...
> A clean, responsive weather application that delivers real-time weather data for any city worldwide.
...
- 🔍 **City-based weather search** — Instantly look up weather for any city in the world
- 🌡️ **Real-time temperature** — Displays current temperature in Celsius
- 💧 **Humidity & conditions** — Shows humidity percentage and weather description
...
git clone https://github.com/Dileep2412/Weather-app.git
...
- Consuming third-party REST APIs using `fetch()`
